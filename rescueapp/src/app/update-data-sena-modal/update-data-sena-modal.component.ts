...
@Component({
  selector: 'app-update-data-sena-modal',
  templateUrl: './update-data-sena-modal.component.html',
  styleUrls: ['./update-data-sena-modal.component.scss'],
})
export class UpdateDataSenaModalComponent  implements OnInit {
