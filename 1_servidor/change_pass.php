...
if (isset($_POST['email'])) {
    ...
    try {
        ...
        $mail->Body = 'Hola, <br/> Has solicitado cambiar tu contraseña en RescueApp. Tu código de verificación es: <b>' . $code . '</b>. <br/> Por favor, introduce este código en la aplicación para continuar con el cambio de contraseña. <br/> ¡Gracias por usar RescueApp!';
